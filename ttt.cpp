...
std::pair<int, int> get_user_input(const std::string& input) {
    if (input == "A1") return {0, 0};
    if (input == "A2") return {0, 1};
    if (input == "A3") return {0, 2};
    if (input == "B1") return {1, 0};
    if (input == "B2") return {1, 1};
    if (input == "B3") return {1, 2};
    if (input == "C1") return {2, 0};
    if (input == "C2") return {2, 1};
    if (input == "C3") return {2, 2};
